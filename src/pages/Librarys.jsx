...
const Products = () => {
    ...
    const itemsPerPage = 6; // Số lượng ảnh hiển thị trên mỗi trang
    ...
    const filteredImages = useMemo(
        () =>
            activeCategory === 'Tất cả' ? galleryData : galleryData.filter((item) => item.category === activeCategory),
        [activeCategory],
    );
                    ...
                    <div className="absolute top-0 left-0 right-0 p-4 flex justify-between items-center z-50">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className="text-white/70 cursor-pointer hover:text-white p-2 rounded-full hover:bg-white/10 transition-colors"
                                title="Tải ảnh"
                            >
                                <FaDownload size={24} />
                            </button>
