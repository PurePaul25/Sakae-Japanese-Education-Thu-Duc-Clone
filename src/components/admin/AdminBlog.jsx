    ...
    return (
        <div className="border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
            ...
            <div
                ...
                onPaste={handlePaste}
                className="min-h-[220px] max-h-[400px] overflow-y-auto px-2.5 py-2 bg-white dark:bg-slate-900 text-slate-800 dark:text-white text-[16px] focus:outline-none whitespace-pre-wrap break-words leading-8
